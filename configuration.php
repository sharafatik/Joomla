...
class JConfig
{
	...
	public $user = 'lmiowl_jos1';                       // DB username
	public $password = 'I([ya]nqzTc(v((&(s^40^(8';                   // DB password
	public $db = 'lmiowl_jos1';                         // DB database name
	public $dbprefix = 'jos_';               // Do not change unless you need to!

	/* Server Settings */
	public $secret = 'aeUCjtMF7wW0r0Ki';     // Change this to something more secure
	public $gzip = '0';
	...
	public $ftp_enable = '';
	public $tmp_path = '/home/lmiowl/sharafat.owlstudio.kz/tmp';                // Please check with your host that this is the correct path to the temp directory. This path needs to be writable by Joomla!
	public $log_path = '/home/lmiowl/sharafat.owlstudio.kz/logs';           // Please check with your host that this is the correct path to the logs directory. This path needs to be writable by Joomla!
